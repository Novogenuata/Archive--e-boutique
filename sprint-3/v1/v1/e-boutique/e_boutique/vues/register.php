...
:root {
    ...
    --logoColor: #0066CC;
        ...
        .bodyInBody_cn_cr {
            background-image: linear-gradient(var(--header_AND_footer), var(--body), var(--body), var(--header_AND_footer));
            padding: 20px;
            display: flex;
    ...
    ?>
        ...
        <div>
            <form method="post">
                ...
                <div><input type="checkbox" name="accepter" id="terms"> <label for="accepter">Accepter les <a href="termscond.php" target="_blank">termes et conditions d'utilisation</a></label></div>
