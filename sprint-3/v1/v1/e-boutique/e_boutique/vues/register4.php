    ...
    ?>
        ...
        <div>
            <form method="post">
                ...
                <div>
                    <input type="checkbox" name="accepter" id="terms">
                    <label for="accepter">Accepter les <a href="#" onclick="event.preventDefault(); alert('1. Soyez poli \n2. Suivez les règlements \n3. Respectez les autres utilisateurs');">termes et conditions d'utilisation</a></label>
                </div>
